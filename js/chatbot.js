...
class ChatbotController {
    ...
    renderButton(text, iconClass, onClick, isBack = false, container = this.elements.optionContainer) {
        ...
        // Only scroll if we are appending directly to the main container
        if (container === this.elements.optionContainer) {
            this.scrollToBottom();
        }
    }
