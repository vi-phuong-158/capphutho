...
(function () {
    ...
    const translations = {
        vi: {
            ...
            'search.aria': 'Tìm kiếm thủ tục hành chính, địa bàn và Cảnh sát khu vực',
            'search.placeholder': 'Tìm thủ tục, địa bàn hoặc Cảnh sát khu vực (Ví dụ: Tân Lập, Định danh...)',
        ...
        en: {
            ...
            'search.aria': 'Search procedures, areas and local police officers',
            'search.placeholder': 'Search procedures, areas or police officers (e.g. Tan Lap, VNeID...)',
        ...
        'zh-CN': {
            ...
            'search.aria': '搜索行政手续、辖区和社区警员',
            'search.placeholder': '搜索手续、辖区或社区警员（例如：Tân Lập、居住登记...）',
            'grid.title': '在线服务',
            'grid.badge': '24/7',
