...
(function () {
    ...
    const translations = {
        ...
        en: {
            ...
            'card.complaint.desc': 'Submit petitions and feedback',
            'card.foreigner.title': 'Foreign Nationals',
            'card.foreigner.desc': 'Temporary residence, visa, immigration',
        ...
        'zh-CN': {
            ...
            'card.complaint.desc': '提交申请、反映情况',
            'card.foreigner.title': '外国人服务',
            'card.foreigner.desc': '临时住宿申报、签证、出入境',
