...
window.FaqSearchEngine = class FaqSearchEngine {
    constructor() {
        this.index = [];
        this.cache = new Map(); // Bounded memoization cache
        this.buildIndex();
    }
    ...
    search(query) {
        ...
        // Chấm điểm độ phù hợp (Simple Scoring) - Optimized with single loop
        const results = [];
        ...
        // Bounded cache to prevent memory leaks (max 100 entries)
