...
window.FaqSearchEngine = class FaqSearchEngine {
    ...
    search(query) {
        ...
        const results = [];
        // Optimization: Use for-loop instead of map/filter to avoid unnecessary object creation
        // and reduce memory pressure (garbage collection) during search.
        for (let i = 0; i < this.index.length; i++) {
            ...
            // Use for-loop to avoid closure creation in forEach
