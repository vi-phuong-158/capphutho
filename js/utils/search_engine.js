...
window.FaqSearchEngine = class FaqSearchEngine {
    constructor() {
        this.index = [];
        this.cache = new Map(); // Performance optimization: Memoize frequent queries
        this.buildIndex();
    }
    ...
    search(query) {
        ...
        // Performance: Single loop optimization replacing .map().filter()
        ...
        // Performance: Limit cache size to 100 entries using FIFO eviction
